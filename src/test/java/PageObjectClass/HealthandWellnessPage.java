...
public boolean ClickOnHealthwithInvalidData(String name, String comp, String num, String email) throws InterruptedException
{
	
	Your_Name.sendKeys(name);
	Thread.sleep(3000);
	Your_Organization_Name.sendKeys(comp);
	Contact_number.sendKeys(num);
	Your_EmailId.sendKeys(email);
	Your_organizationSize.click();
	Range_organizationSize.click();
	You_are_interestedInbutton.click();
	You_are_interestedIn.click();
